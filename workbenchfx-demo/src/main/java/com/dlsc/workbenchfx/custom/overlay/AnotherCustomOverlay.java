...
public class AnotherCustomOverlay extends BorderPane implements Overlay {

  private WorkbenchFx workbench;
  private final boolean blocking;

  public AnotherCustomOverlay(boolean blocking) {
    this.blocking = blocking;
    init();
  }

  private void init() {
    getStyleClass().add("another-custom-overlay");

    Label centerLbl = new Label("This is another example of a custom overlay!");
