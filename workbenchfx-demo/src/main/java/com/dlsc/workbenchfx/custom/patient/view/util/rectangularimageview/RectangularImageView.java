package com.dlsc.workbenchfx.custom.patient.view.util.rectangularimageview;
...
public class RectangularImageView extends Control {
    ...
    private final SimpleObjectProperty<Dimension2D> imageSize = new SimpleObjectProperty<>(this, "imageSize", new Dimension2D(410, 300));
