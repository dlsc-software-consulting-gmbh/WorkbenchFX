package com.dlsc.workbenchfx.custom.patient.view.util.numberrange;
...
public class FridayFunSkin extends SkinBase<NumberRangeControl> implements CustomControlMixin{
    ...
    private final ChangeListener<Number> angleListener = (observable, oldValue, newValue) -> relocateThumb(newValue.doubleValue());

    private final ChangeListener<Number> minMaxListener = (observable, oldValue, newValue) -> Platform.runLater(this::updateTickLabels);
    ...
    public void initializeSelf() {
        addStylesheetFiles(getSkinnable(), "/fonts/fonts.css", "/com/dlsc/workbenchfx/custom/patient/view/util/numberrange/fridayFunStyle.css");
    }
    ...
    private void resize() {
        ...
        if (availableWidth > 0 && availableHeight > 0) {
            drawingPane.relocate((getSkinnable().getWidth() - ARTBOARD_SIZE) * 0.5, (getSkinnable().getHeight() - ARTBOARD_SIZE) * 0.5);
