...
import com.dlsc.workbenchfx.custom.patient.view.util.numberrange.SkinType;
import com.dlsc.workbenchfx.custom.patient.view.util.rectangularimageview.RectangularImageView;
...
class PatientView extends HBox implements ViewMixin {
    ...
    public void setupBindings() {
        ...
        yearOfBirthField.textProperty().bindBidirectional(patient.yearOfBirthProperty(), new NumberStringConverter(){
            @Override
        ...
        genderField.textProperty().bindBidirectional(patient.genderProperty(), new StringConverter<Patient.Gender>() {
            @Override
        ...
        bloodPressureSystolicControl.valueProperty().bindBidirectional(patient.bloodPressureSystolicProperty());
        bloodPressureDiastolicControl.valueProperty().bindBidirectional(patient.bloodPressureDiastolicProperty());
