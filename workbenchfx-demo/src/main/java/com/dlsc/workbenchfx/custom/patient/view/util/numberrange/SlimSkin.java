...
class SlimSkin extends SkinBase<NumberRangeControl> {
    ...
    private static final String STYLE_CSS = "/com/dlsc/workbenchfx/custom/patient/view/util/numberrange/slimStyle.css";
    ...
    private final ChangeListener<Number> resizeListener = (observable, oldValue, newValue) -> resize();
