...
public class SelectionStrip<T> extends Control {
    ...
    private final ObjectProperty<Duration> animationDuration = new SimpleObjectProperty<>(this, "animationDuration", Duration
        .millis(200));
    ...
    private final ObjectProperty<Callback<SelectionStrip, StripCell<T>>> cellFactory = new SimpleObjectProperty<>(this, "cellFactory");
