...
<<img-blender>> below gives a short impression of the program and <<characteristics-blender>> after the image shows our findings.
...
Since it requires a little experience to use it properly we think it's made primary for power users.
<<img-photoshop>> below gives a short impression of the program and <<characteristics-photoshop-illustrator>> after the image shows our findings.
...
<<img-intellij>> below gives a short impression of the program and <<characteristics-intellij>> after the image shows our findings.
