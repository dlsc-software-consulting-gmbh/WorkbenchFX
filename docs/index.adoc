...
== Summary
// TODO: François
// TODO: Summary: problemstellung, vorgehen, hauptergebnisse,
WorkbenchFX is a Java based JavaFX library which can be used to build very fast large enterprise applications.
