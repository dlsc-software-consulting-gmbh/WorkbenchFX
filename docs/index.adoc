...
|===
|Term        |Explanation
|Module      |The workbench object consists of multiple views. The object which contains the view is called Module. (More information about link:#_module_naming[module naming])
...
* The link:#_workbenchmodule_lifecycle[module lifecycle] which enables the user to open, deactivate and close the module
...
==== Dieter Holz, Advisor
During the "Hacking Days" we've made from time to time (more about them in chapter link:#_hacking_day[Hacking Day]), our advisor tested the API by implementing a module on his own.
...
Most of the applications analyzed in chapter link:#_applications[Applications] use the tab concept to switch between their files.
...
// TODO: Verschachtelt to english
Is much easier to read thanks to the folded code writing.
