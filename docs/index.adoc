...
// TODO: Find better naming for "Weitere Ausführung", "Folgende Erläuterungen", etc.
During the documentation, some terms are used.
In following <<terms-declaration>> it is shown in what context they are used.
...
The image below gives a short impression of the tool and the table below shows our findings.
// TODO: Insert image
...
The image below gives a short impression of the tools and the table below shows our findings.
// TODO: Insert image

.Photoshop (Image tool, Pixel based) / Illustrator (Design tool, Vector based)
...
==== IntelliJ IDEA
An integrated development environment (IDE) which is used to develop a variety of programs.
...
Compared with its siblings (Photoshop and Illustrator), Adobe XD's visual appearance is much simpler and cleaner.
It is a tool used for prototyping.
Using it is much easier and intuitive than the other products tested before.
It can also be used by non power users.
The image below gives a short impression of the program and the table below shows our findings.

.Adobe XD
[#characteristics-adobe-xd]
|===
|Characteristics |Positive Impressions |Negative Impressions
|
|
...
// TODO: Write Chapter
// TODO: (mehr fokus auf ist eifach, keine docking elemente usw., was unterscheidet von anderen)
Like the tool in previous chapter, Figma is a tool used for prototyping.
Using it is also very easy and intuitive.
It can used by non power users.
The image below gives a short impression of the program and the table below shows our findings.

.Figma
[#characteristics-figma]
|===
|Characteristics |Positive Impressions |Negative Impressions
|
|
...
* The phase when we were writing our own stylesheet without any help of external sources.
* The phase where we switched over using the Material Design standards.
* The phase after the usability tests, where we separated the single bar on top into the toolbar and the tab bar and went full material
...
=== Development
// TODO: Google Java style guidelines
