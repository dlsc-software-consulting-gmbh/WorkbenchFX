...
A bit later on in the project, he told us to switch back to Java 9, as he noticed dependencies were not ready for Java 10 yet, as most of the other developers have not switched to Java 10 yet.
