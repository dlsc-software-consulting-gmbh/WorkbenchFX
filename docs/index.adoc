...
We didn't have to always build the branch to see the code coverage and the check on GitHub was at the same time kind of a reminder, to take a look at the code coverage as well.
