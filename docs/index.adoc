...
As stated in <<_user_stories>> we held a workshop with our customer in the beginning of our project.
...
This way we could ensure that all of our implemented features satisfy a special need.

Together with the persona and the user stories it felt almost like the written stories and persona are people with problems in real life.
Exactly this feeling proved us that the user stories and persona are really helpful for us.
Because during the project we could always refer to the persona and stories and ask ourselves:
