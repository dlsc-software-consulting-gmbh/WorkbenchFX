...
|Each view shows the same part, but it's view is independent
...
To ensure a shared understanding between the customer and ourselves, we agreed on a minimum viable product (MVP).
