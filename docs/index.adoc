...
First of all we would like to thank our customer, Dirk Lemmermann for enabling us to work on this project.
He provided us with example code of his latest project to use as an inspiration.
...
His feedback led to important changes of the API syntax and had even an influence on new features.

Additional acknowledgements to Annelore Egger.
She took the role as API tester and provided a lot of useful feedback.
Additionally she helped us a lot when she reviewed our documentation and revealed unclear formulations.

Many thanks to Horst Bauer for reviewing our document.
As an impartial reviewer he provided additional feedback.

We would like to thank especially the UX expert who supported us during the usability test phase.
His feedback was leading to an overall improvement of our styling.
