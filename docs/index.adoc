...
.Persona
|===
|image:include/persona/stefanie_berner.png[Stefanie Berner], link:persona/stefanie_berner.png[Stefanie "SteffieFX" Berner]
|image:include/persona/fabian_zimmer.png[Stefanie Berner], Fabian Zimmer
|image:include/persona/anna_leutner.png[Stefanie Berner], Anna Leutner
|===
