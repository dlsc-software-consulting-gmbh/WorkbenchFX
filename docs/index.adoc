...
// beschreiben one dialogcontrol, then switch model object, usw. => text ausgetauscht von dialog
...
It turned out calling `showOverlay()` to show the second dialog was called fractions of a second earlier than `hideOverlay()`. // TODO
