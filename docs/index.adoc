...
Since it requires a little experience to use it properly we think it's made primarily for power users.
...
This lead to an inconsistent coloring and destroyed the tab's look and feel.
